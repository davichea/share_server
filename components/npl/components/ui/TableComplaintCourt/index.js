...
const columns = [
    ...
    {
        id: "SubCourtEng",
        name: "First Instance ENG",
    },
    {
        id: "SubCourtKhm",
        name: "First Instance KHM",
    },
    // {
    //     id: "description",
    //     name: "Description",
...
const TableComplaintCourt = ({
    ...
    // console.log('TableComplaintCourt', data)
                                    ...
                                    totalRows === 0 ?
                                        ...
                                        (
                                            data?.map((row, index) => {
                                                ...
                                                return (
                                                    <tr
                                                        key={row.firstInstanceID}
                                                        onClick={() => onRowClick(row)}

                                                        className={`cursor-pointer transition-all duration-500 ${selectedId === row.firstInstanceID
                                                            ? 'bg-slate-100'
                                                            : 'hover:bg-gray-100'
                                                            }`}
                                                    >
                                                        ...
                                                        <TableDataCell className='py-2 text-xs'>
                                                            {row["First Instance ENG"]}
                                                        </TableDataCell>

                                                        <TableDataCell className='py-2 text-xs'>
                                                            {isEmptyRow(row["First Instance KHM"])}
                                                        </TableDataCell>
                                                        ...
                                                        <TableDataCell className='py-2 text-xs'>
                                                            {isEmptyRow(row.Location)}
                                                        </TableDataCell>

                                                        <TableDataCell className='flex justify-center items-center py-1.5 px-5 text-xs'>
...
export default TableComplaintCourt
